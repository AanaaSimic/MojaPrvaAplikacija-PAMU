  ...
  return ( 
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}> 
      ...
      <HardwareFeatureCard 
        ...
        description="Bluetooth, NFC, napredni audio i IoT integracije često traže dodatne native module, fizički uređaj i development 
build. U ovoj vježbi ih prikazujemo kao nastavak teme za naprednije vježbe." 
      > 
